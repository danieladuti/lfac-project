...
class ParamList {
    ...
    ASTNode* expr;
    ParamList() {}
    ParamList(string type, string name);
    ParamList(ParamList* p, string type, string name);
    ParamList(string type, string name, ASTNode* e);
...
class SymTable {
    ...
    ParamList* getParams(string name);
